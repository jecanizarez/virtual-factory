...
The files below describe the process pipeline, control modes, the automatic cycle, \
and the full Modbus register/coil map. Larger files (e.g. the FUXA project JSON) are \
